...
void lednicky_integration_pd() {
    ...
    // Scattering parameters (https://doi.org/10.1016/S0370-2693(99)01366-0)
    //double a0s_pd = -0.13;   // fm - singlet
    //double r0s_pd = 0.;    // fm - singlet
    //double a0t_pd = 14.7;  // fm - triplet
    //double r0t_pd = 0.;    // fm - triplet
    ...
    TFile* outfile = TFile::Open("output/lednicky_integration_pd_Bhawani_pars.root", "RECREATE");
...
void lednicky_integration_pp() {
    std::cout << "Starting Lednicky integration..." << std::endl;
    
    // Scattering parameters (https://www.nature.com/articles/s42005-023-01221-0)
    double a0s_pd = -18.17;   // fm - singlet
    double r0s_pd = 2.80;    // fm - singlet
    
    LednickyCoulombWavefunction wf(
        Constants::M_PROTON, Constants::M_PROTON,
        Constants::Z_PROTON, Constants::Z_PROTON,
        a0s_pd, r0s_pd, 0., 0.,
        1., 0.
    );
    ...
    TFile* outfile = TFile::Open("output/lednicky_integration_pp.root", "RECREATE");
    ...
    std::cout << "\nDone! Output written to output/lednicky_integration_pp.root" << std::endl;
}
